...
function Board({ tiles,onTileClick}) {
    ...
    return <div className="board">
        ...
        <Tileplayer = {player}  onclick = {()=>onTileClick(1)} value = {tiles[1]}className = " right-border bottom-border"/>
        <Tileplayer = {player}  onclick = {()=>onTileClick(2)} value = {tiles[2]} className = "  bottom-border"/>
        ...
        <Tile player = {player} onclick = {()=>onTileClick(6)} value = {tiles[6]} className = " right-border r"/>
